...
class StoreApplicationTest extends TestCase
{
     ...
     *
     * StoreApplicationRequestの正常系テスト
     *
    ...
    public static function passesStoreValidateValueProvider(): array
    {
        ...
        return [
            '申請のバリデーションで出勤、退勤、休憩、備考を入力し、正常に申請がされる_備考は255文字' => [
                [
     ...
     *
     * StoreApplicationRequestの異常系テスト
     *
     * @param  array  $value  データプロバイダーから受け取るテストデータ
     */
    ...
    public static function failsStoreValidateValueProvider(): array
    {
        ...
        return [
            '申請のバリデーションで出勤に入力せず、バリデーションエラーとなる' => [
                [
                    'new_clock_in' => '',
                    'new_clock_out' => '18:00:00',
                    'new_break_in' => ['12:00:00', '13:00:00'],
            ...
            '申請のバリデーションで出勤に文字列を入力し、バリデーションエラーとなる' => [
                [
                    'new_clock_in' => 'test',
                    'new_clock_out' => '18:00:00',
                    'new_break_in' => ['12:00:00', '13:00:00'],
            ...
            '申請のバリデーションで退勤時刻より後の出勤時刻を入力し、バリデーションエラーとなる' => [
                [
            ...
            '申請のバリデーションで退勤に文字列を入力し、バリデーションエラーとなる' => [
                [
                    'new_clock_in' => '09:00:00',
                    'new_clock_out' => 'test',
                    'new_break_in' => ['12:00:00', '13:00:00'],
            ...
            '申請のバリデーションで出勤時刻より前の退勤時刻を入力し、バリデーションエラーとなる' => [
                [
                    'new_clock_in' => '09:00:00',
            ...
            '申請のバリデーションで休憩入に配列以外を入力し、バリデーションエラーとなる' => [
                [
                    'new_clock_in' => '09:00:00',
                    'new_clock_out' => '18:00:00',
                    'new_break_in' => 'test',
            ...
            '申請のバリデーションで休憩入に文字列の入った配列を入力し、バリデーションエラーとなる' => [
                [
                    'new_clock_in' => '09:00:00',
                    'new_clock_out' => '18:00:00',
            ...
            '申請のバリデーションで退勤時刻より後の休憩入時刻の入った配列を入力し、バリデーションエラーとなる' => [
                [
                    'new_clock_in' => '09:00:00',
                    'new_clock_out' => '18:00:00',
            ...
            '申請のバリデーションで出勤時刻より前の休憩入時刻の入った配列を入力し、バリデーションエラーとなる' => [
                [
                    'new_clock_in' => '09:00:00',
                    'new_clock_out' => '18:00:00',
            ...
            '申請のバリデーションで休憩戻に配列以外を入力し、バリデーションエラーとなる' => [
                [
                    'new_clock_in' => '09:00:00',
                    'new_clock_out' => '18:00:00',
                    'new_break_in' => ['12:00:00', '13:00:00'],
            ...
            '申請のバリデーションで休憩戻に文字列の入った配列を入力し、バリデーションエラーとなる' => [
                [
                    'new_clock_in' => '09:00:00',
                    'new_clock_out' => '18:00:00',
                    'new_break_in' => ['12:00:00', '13:00:00'],
            ...
            '申請のバリデーションで退勤時刻より後の休憩戻時刻の入った配列を入力し、バリデーションエラーとなる' => [
                [
                    'new_clock_in' => '09:00:00',
                    'new_clock_out' => '18:00:00',
                    'new_break_in' => ['12:00:00', '13:00:00'],
